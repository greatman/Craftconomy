...
public class Account
{
	...
	public BigDecimal addMoney(BigDecimal amount)
	{
		...
		else return addMoney(amount, CurrencyHandler.getCurrency(Config.currencyDefault, true), Craftconomy.plugin
	...
	public BigDecimal addMoney(BigDecimal amount, Currency currency)
	{
		...
		else return addMoney(amount, currency, Craftconomy.plugin.getServer().getWorlds().get(0));
	}
	...
	public BigDecimal substractMoney(BigDecimal amount)
	{
		...
		else return substractMoney(amount, CurrencyHandler.getCurrency(Config.currencyDefault, true),
	...
	public BigDecimal substractMoney(BigDecimal amount, Currency currency)
	{
		...
		else return substractMoney(amount, currency, Craftconomy.plugin.getServer().getWorlds().get(0));
	}
	...
	public BigDecimal multiplyMoney(BigDecimal amount)
	{
		...
		else return multiplyMoney(amount, CurrencyHandler.getCurrency(Config.currencyDefault, true), Craftconomy.plugin
				.getServer().getWorlds().get(0));
	}
	...
	public BigDecimal multiplyMoney(BigDecimal amount, Currency currency)
	{
		...
		else return multiplyMoney(amount, currency, Craftconomy.plugin.getServer().getWorlds().get(0));
	}
	...
	public BigDecimal divideMoney(BigDecimal amount)
	{
		...
		else return divideMoney(amount, CurrencyHandler.getCurrency(Config.currencyDefault, true), Craftconomy.plugin
				.getServer().getWorlds().get(0));
	}
	...
	public BigDecimal divideMoney(BigDecimal amount, Currency currency)
	{
		...
		else return divideMoney(amount, currency, Craftconomy.plugin.getServer().getWorlds().get(0));
	}
	...
	public BigDecimal setBalance(BigDecimal amount)
	{
		...
		else return setBalance(amount, CurrencyHandler.getCurrency(Config.currencyDefault, true), Craftconomy.plugin
				.getServer().getWorlds().get(0));
	}
	...
	public BigDecimal setBalance(BigDecimal amount, Currency currency)
	{
		...
		else return setBalance(amount, currency, Craftconomy.plugin.getServer().getWorlds().get(0));
	}
	...
	public boolean hasEnough(BigDecimal amount)
	{
		...
		else return hasEnough(amount, CurrencyHandler.getCurrency(Config.currencyDefault, true), Craftconomy.plugin
				.getServer().getWorlds().get(0));
	}
	...
	public boolean hasEnough(BigDecimal amount, Currency currency)
	{
		...
		else return hasEnough(amount, currency, Craftconomy.plugin.getServer().getWorlds().get(0));
	}
